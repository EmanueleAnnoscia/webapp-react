...
import ReviewNewForm from "../components/review_components/ReviewNewForm";
...
const MovieDetails = () => {
    ...
    return (
        <main>
            ...
            {movie && (
                <section className="container justify-content-center py-5">
                    <h2 className="text-center">LASCIA LA TUA RECENSIONE 📖</h2>
                    <div className="row">     
                        <ReviewNewForm movie_id={movie.id} reloadReviews={getMovieDetails} />
                    </div>
                </section>
            )}
